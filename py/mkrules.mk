...
# make a list of all the .py fies that need compiling and freezing
FROZEN_MPY_PY_FILES := $(shell /cygdrive/c/cygwin64/bin/find.exe -L $(FROZEN_MPY_DIR) -type f -name '*.py' | $(SED) -e 's=^$(FROZEN_MPY_DIR)/==')
